...
StudentNode::StudentNode(istream& is): left(0),right(0)  // Default constructor, which reads data from an istream(default cin)
{	
	//int i=0;
...
StudentNode::StudentNode(string method): left(0), right(0) //RANDOM Node creation
